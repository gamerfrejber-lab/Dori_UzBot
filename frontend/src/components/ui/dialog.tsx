...
>(({ className, children, ...props }, ref) => (
  <DialogPortal>
    ...
    <DialogPrimitive.Content
      ref={ref}
      className={cn(
        'fixed left-[50%] top-[50%] z-50 w-[calc(100%-32px)] max-w-lg translate-x-[-50%] translate-y-[-50%] bg-white rounded-[28px] p-5 sm:p-6 shadow-2xl max-h-[90vh] overflow-y-auto',
